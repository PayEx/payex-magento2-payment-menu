...
use PayEx\PaymentMenu\Api\Data\PaymentActionInterface;
...
{
    const EVENT_NAME_PREFIX = 'payex_paymentmenu_';
    ...
    public function execute()
    {
        if (!$this->configHelper->isActive()) {
            ...
            return $this->setResult(
                __('Not Found: The required PayEx Checkout resources does not seem to be available'),
                404
            );
        }
